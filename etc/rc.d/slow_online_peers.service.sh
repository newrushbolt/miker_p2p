...
# Default-Stop:      0 1 6
# Short-Description: Starts P2P slow_online_peers workers
# Description:       Starts P2P slow_online_peers workers
### END INIT INFO

NAME='slow_online_peers.worker'
WORKER='slow_online_peers.worker.rb'
...
start() {
    for (( i = 1; i <= $SLOW_ONLINE_PEERS_WORKERS; i++ ))
    do
