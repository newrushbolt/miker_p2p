...
# Default-Stop:      0 1 6
# Short-Description: Starts P2P common_online_peers workers
# Description:       Starts P2P common_online_peers workers
### END INIT INFO

NAME='common_online_peers.worker'
WORKER='common_online_peers.worker.rb'
...
start() {
    for (( i = 1; i <= $COMMON_ONLINE_WORKERS; i++ ))
    do
