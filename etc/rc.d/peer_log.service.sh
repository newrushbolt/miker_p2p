...
# Default-Stop:      0 1 6
# Short-Description: Starts P2P peer_log workers
# Description:       Starts P2P peer_log workers
### END INIT INFO

NAME='peer_log.worker'
WORKER='peer_log.worker.rb'
