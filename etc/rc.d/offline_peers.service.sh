...
# Default-Stop:      0 1 6
# Short-Description: Starts P2P offline_peers workers
# Description:       Starts P2P offline_peers workers
### END INIT INFO

NAME='offline_peers.worker'
WORKER='offline_peers.worker.rb'
...
start() {
    for (( i = 1; i <= $OFFLINE_PEERS_WORKERS; i++ ))
    do
