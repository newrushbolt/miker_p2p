...
# Default-Stop:      0 1 6
# Short-Description: Starts P2P peer_list_master
# Description:       Starts P2P peer_list_master
### END INIT INFO

NAME='peer_list_master'
WORKER='peer_list_master.worker.rb'
...
start() {
    for (( i = 1; i <= $PEER_LIST_MASTER_WORKERS; i++ ))
    do
